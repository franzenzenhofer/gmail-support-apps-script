...
class StorageValidator {
  static get MAX_PROPERTY_SIZE() { return 450 * 1024; } // 450KB (leaving buffer)
  static get MAX_CACHE_SIZE() { return 100 * 1024; }    // 100KB for cache
...
class ExecutionTimer {
  static get startTime() { return this._startTime || null; }
  static set startTime(value) { this._startTime = value; }
  static get maxRuntime() { return 5 * 60 * 1000; } // 5 minutes (leave 1 min buffer)
